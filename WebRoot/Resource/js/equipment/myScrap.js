...
function loadScrapList(){
	$('#scrapList').datagrid({
		...
		columns : [ [
		            ...
		            /* {field : 'applyName',title : '报废人',width : '10%',align : 'center', sortable:true},
		             {field : 'applyLevel',title : '报废人角色',width : '10%',align : 'center', sortable:true},*/
		             {field : 'applyDate',title : '报废申请日期',width : '10%',align : 'center', sortable:true},
		             ...
		             {field : 'scrapReason', title : '报废说明', width : '20%', align : 'center' },
