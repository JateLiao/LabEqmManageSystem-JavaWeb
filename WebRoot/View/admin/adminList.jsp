...
<script type="text/javascript" src="<%=basePath%>/Resource/js/admin/adminList.js"></script>
</head>
<body>
<div class="admin_list_main" >
	<div class="admin_list_center">
		...
		<div id="adminList" class="admin_list_adminList"></div>
	</div>
	<div id="modifyPermissionWindow">
		<div id="modify_permission" style="display: none; margin-top: 10px; margin-left: 10px;">
			<span>当前角色：</span>
			<select id="permissionCurrent" class="easyui-combobox" data-options="editable:false,panelHeight:'150px'" disabled="disabled" style="width: 120px; ">
					<option>设备管理员</option>
					<option>实验室管理员</option>
					<option>超级管理员</option>
			</select>
			<span style="margin-left: 20px;">修改后角色：</span>
			<select id="permissionTarget" class="easyui-combobox" data-options="editable:false,panelHeight:'150px'"  style="width: 120px; ">
					<option>设备管理员</option>
					<option>实验室管理员</option>
					<option>超级管理员</option>
			</select><br>
			<div style="margin-top: 25px;">
				<a href="javascript:void(0)" id="ok_btn" onclick="modifyPermission();" class="easyui-linkbutton" iconCls="icon-ok" style="width: 95px; margin-left: 150px;">修改</a>
				<a href ="javascript:void(0)" id="cancelBtn" class="easyui-linkbutton" iconCls="icon-cancel" style="width: 95px; margin-left: 30px;">取消</a>
			</div>
		</div>
	</div>
</div> 
